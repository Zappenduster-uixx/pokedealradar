...
export default function HomePage() {
  ...
  const filteredOffers = useMemo(() => {
    ...
    return offers
      .filter((offer) => {
        const searchText = `${offer.title} ${offer.retailer} ${offer.category} ${offer.description}`.toLowerCase();
        ...
        const minMatches = min === null || (parsedPrice !== null && parsedPrice >= min);
        const maxMatches = max === null || (parsedPrice !== null && parsedPrice <= max);
  ...
  return (
    <main className="min-h-screen bg-zinc-950 px-4 py-8 text-white">
      <section className="mx-auto max-w-7xl">
        ...
        <section className="mb-8 rounded-3xl border border-zinc-800 bg-zinc-900 p-5">
          <div className="grid gap-4 lg:grid-cols-4">
            <div className="lg:col-span-2">
              ...
              <input
                ...
                placeholder="z. B. Booster, ETB, Müller..."
            ...
            <div>
              ...
              <select
                ...
                onChange={(event) => setSelectedDealType(event.target.value)}
                className="w-full rounded-2xl border border-zinc-700 bg-zinc-950 px-4 py-3 text-white outline-none focus:border-yellow-400"
              >
                <option>Alle</option>
